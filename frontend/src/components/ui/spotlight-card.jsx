...
// Inject the [data-glow] pseudo-element styles once into <head>
...
function injectGlowStyles() {
  ...
  style.textContent = [
    ...
    '    transparent 100%);filter:brightness(2);}',
    '[data-glow]::after{',
    '  background-image:radial-gradient(',
...
export function GlowCard({
  ...
  return (
    <div ref={cardRef} data-glow style={inlineStyles} className={classes}>
